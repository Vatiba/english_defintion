...
function draw_about_us() {
    ...
    elContainer_1.append("<div class='container'><div class='d-flex justify-content-center mt-3 mb-3'><div class='h5 text-white p-3 text-center' style='border-radius: 2rem; border: 1px solid white; width:'>About us.</div></div><div class='pr-3 pl-3 text-white'><p>This app was created to ease understanding of English tenses for people.Creators are students of Oguz Han engineering and technology university.Yaylymow Bezirgen, Tuvakov Abdyjelil, Rozmetov Timur, Hudayberdiyev Davud.</p><p>If there is a mistake or you have some suggestions please contact us.</p><p>Contact: <a href='http://eetengtense@gmail.com'>eetengtense@gmail.com</a></p><img src='img/Image.jpeg' class='container p-0 pb-3'></div></div>")
...
function draw_past_screen() {
    ...
    function draw_simple_screen() {
        var elContainer_1 = $("body").empty();
        elContainer_1.append("<div class='container'><div id='back' class='btn btn-outline-light btn-lg btn-block mb-4 mt-4' style='border-radius: 2rem;'>Back</div></div>")
        elContainer_1.append("<div class='container'><div class='d-flex justify-content-center mt-3 mb-3'><div class='h5 text-white p-3 text-center' style='border-radius: 2rem; border: 1px solid white; width:'>Past Simple Tense Definition</div></div><div class='pr-3 pl-3 text-white'><p><p>Past Simple shows finished action which began and finished in the past. Auxiliary verb of Past Simple is (Did in positive, Didn't is in negative). These are time expressions: Yesterday, ago, last</p><p>Verb to be turns into was/were in the Past Simple. Was is used with (I, He, She, It). Were is used with (They, We, You). Negative form of was/were is wasn't/weren't.</p><p>Question form auxiliary verb (did) to the beginning of the sentence or if there is a verb to be in the sentence. Ex: I was at the meeting three hours ago. Verb to be moves to the beginning. Ex: Were you at the meeting three hours ago?</p><p><p>Structure of Past Simple.</p><p>Positive:</p><p><p>Subject + V2/(ed) + Object.</p>I watched TV yesterday.<br>She went to Avaza two years ago.<br>We were in USA last year.</p><br><p>Negative:</p><p><p>Subject + didn't + V1 + Object.</p><p>Notice after (didn't) we use only V1, we can't use V2/(ed) because we already have auxiliary verb of Past Simple (didn't).</p>He didn't bring his laptop two days ago.<br>I wasn't at the party last week.<br>The test didn't start a minute ago. It started five minutes ago.</p><p>Question:</p><p><p>Did /Didn't + Subject + V1 + Object.</p>Did you play tennis yesterday evening?<br>Didn't you visit your friend at the hospital?<br>Were you at the meeting?<br></p></p></p></div></div>")
    ...
    function draw_continuous_screen() {
        var elContainer_1 = $("body").empty();
        elContainer_1.append("<div class='container'><div id='back' class='btn btn-outline-light btn-lg btn-block mb-4 mt-4' style='border-radius: 2rem;'>Back</div></div>")
        elContainer_1.append("<div class='container'><div class='d-flex justify-content-center mt-3 mb-3'><div class='h5 text-white p-3 text-center' style='border-radius: 2rem; border: 1px solid white; width:'>Past Continuous Tense Definition</div></div><div class='pr-3 pl-3 text-white'><p><p>Past Progressive (Continuous) indicates duration of an action in the past. It means action started and continued for some time in the past. It is also can be used in parallel actions. Auxiliary verb of Past Progressive (Continuous) is (was/were). These are time expressions: at 5 o'clock yesterday, from... till, whole, while, all day long.</p><p>Negative form is (was + not/ were + not). Note: was + not = wasn't, were + not = weren't.</p><p>Question form is got by putting only auxiliary verb (was/were) to the beginning of the sentence.</p><p><p>Structure of Past Progressive (Continuous)</p><p>Positive:</p><p><p>Subject + was/were + V(ing) + Object</p>I was watching TV, when my Mom came.<br>They were swimming at the pool yesterday morning.<br>He was doing his homework whole day.</p><br><p>Negative:</p><p><p>Subject + wasn't/weren't + V(ing) + Object</p>He wasn't sleeping when a football match started.<br>Students weren't listening, while a teacher was explaining the theme.<br>Yesterday from 5 till 7 Maksat wasn't playing tennis. He was playing chess.</p><p>Question:</p><p><p>Was/Were/Wasn't/Weren't + Subject + V(ing) + Object</p>Were you sleeping yesterday noon?<br>Weren't they listening to the teacher, while she was explaining?<br>Wasn't he doing the homework, when they came?<br></p></p></p></div></div>")
    ...
    function draw_perfect_screen() {
        var elContainer_1 = $("body").empty();
        elContainer_1.append("<div class='container'><div id='back' class='btn btn-outline-light btn-lg btn-block mb-4 mt-4' style='border-radius: 2rem;'>Back</div></div>")
        elContainer_1.append("<div class='container'><div class='d-flex justify-content-center mt-3 mb-3'><div class='h5 text-white p-3 text-center' style='border-radius: 2rem; border: 1px solid white; width:'>Past Perfect Tense Definition</div></div><div class='pr-3 pl-3 text-white'><p><p>Past Perfect tense is used to indicate the action that happened before another action. It is used to make it clear that one event happened before another in the past. In this tense we have to turn the first action in Past Perfect, then the second action into Past simple. Auxiliary verb is (had) Time expressions are: after, when, before, until.</p><p><p>Structure of Past Perfect</p><p>Positive:</p><p><p>Subject + had + V3/V(ed) + Object</p>I had watched this film before it was released.<br>When I phoned to the office, Davud had already left.<br>I was going to the work when I suddenly remembered I had forgot(forgotten) to feed my dog.</p><br><p>Negative:</p><p><p>Subject + hadn’t + V3/V(ed) + Object</p>She hadn’t been at home when I came.<br>Yesterday I knew my friend had flown to New York for 3 months.<br>He hadn’t had a rest before we went to work out. </p><p>Question:</p><p><p>Had/hadn’t + Subject + V3/V(ed) + Object</p>Had she gone before the game ended?<br>Had you known the teacher before he took your exam?<br>Hadn’t he quit smoking before the lungs’ cancer?<br></p></p></p></div></div>")
    ...
    function draw_perfect_continuous_screen() {
        var elContainer_1 = $("body").empty();
        elContainer_1.append("<div class='container'><div id='back' class='btn btn-outline-light btn-lg btn-block mb-4 mt-4' style='border-radius: 2rem;'>Back</div></div>")
        elContainer_1.append("<div class='container'><div class='d-flex justify-content-center mt-3 mb-3'><div class='h5 text-white p-3 text-center' style='border-radius: 2rem; border: 1px solid white; width:'>Past Perfect Continuous Tense Definition</div></div><div class='pr-3 pl-3 text-white'><p><p>Past Perfect Progressive (Continuous) indicates duration of action that started before another action. NOTE: The action shouldn’t be interrupted. Auxiliary verb of Past Perfect Progressive (Continuous) is (had been). These are time expressions: since, for, for ages. Negative form is got by adding “not” to the verb had, had + not = hadn’t. Question form is got by putting the verb had to the beginning of the sentence.</p><p><p>Structure of Past Perfect Progressive (Continuous)</p><p>Positive:</p><p><p>Subject + had + been + V(ing) + Object</p>He had been waiting her for two hours when she came.<br>They had been waiting for a bus since 8:45.<br>He had been playing a game when his father came in.</p><br><p>Negative:</p><p><p>Subject + hadn’t + been + Ving + Object</p>I hadn’t been waiting for you for 5 hours.<br>They hadn’t been studying at the library since morning.<br>She hadn’t been sleeping since 2 o’clock at night.</p><p>Question:</p><p>Had he been sleeping before his mom came?<br>Had you been waiting for a taxi for 10 minutes?<br>Had it been raining since yesterday evening?<br></p></p></p></div></div>")
...
function draw_present_screen() {
    ...
    function draw_continuous_screen() {
        var elContainer_1 = $("body").empty();
        elContainer_1.append("<div class='container'><div id='back' class='btn btn-outline-light btn-lg btn-block mb-4 mt-4' style='border-radius: 2rem;'>Back</div></div>")
        elContainer_1.append("<div class='container'><div class='d-flex justify-content-center mt-3 mb-3'><div class='h5 text-white p-3 text-center' style='border-radius: 2rem; border: 1px solid white; width:'>Present Continuous Tense Definition</div></div><div class='pr-3 pl-3 text-white'><p><p>Present Progressive (Continuous) is used to indicate an activity is being done at the moment. It started in the past, CONTINUES NOW and will end in the future. Auxiliary verb of Present Progressive (Continuous) is the verb to be ('am' for I), ('is' for he and she), ('are' for you, they and we). These are time expressions: now, still, just now, look, listen, this moment, whole, from... till, while, all day long.</p><p>Negative form is (am + not + Ving/ is + not + Ving/ are + not + Ving). Note: are + not = aren't, is + not = isn't.</p><p>Question form is got by putting only auxiliary verb (am/is/are) to the beginning of the sentence.</p><p><p>Structure of Present Progressive (Continuous)</p><p>Positive:</p><p><p>Subject + to be(am/is/are) + V(ing) + Object</p>I am studying now.<br>Look! Somebody is smoking nearby your car.  <br>He is still working on this difficult task.</p><br><p>Negative:</p><p><p>Subject + to be (am/is/are) + not + V(ing) + Object</p>I am not working just now.<br>Students aren't sitting at the class right now.<br>He isn't playing football whole day.</p><p>Question:</p><p><p>To be (am/is/are/isn't/aren't) + Subject + V(ing) + Object</p>Are you playing a computer game now?<br>Is he chatting now?<br>Are they playing football all day long?<br></p></p></p></div></div>")
    ...
    function draw_perfect_screen() {
        var elContainer_1 = $("body").empty();
        elContainer_1.append("<div class='container'><div id='back' class='btn btn-outline-light btn-lg btn-block mb-4 mt-4' style='border-radius: 2rem;'>Back</div></div>")
        elContainer_1.append("<div class='container'><div class='d-flex justify-content-center mt-3 mb-3'><div class='h5 text-white p-3 text-center' style='border-radius: 2rem; border: 1px solid white; width:'>Present Perfect Tense Definition</div></div><div class='pr-3 pl-3 text-white'><p><p>Present Perfect tense is used to indicate a link between the present and the past or to simplify this tense is used to express actions that started in the past and continue up to the present. There no exact time in Present Perfect. Auxiliary verb is (have/has). Time expressions: ever, never, before, already, yet, just.</p><p><p>Structure of Present Perfect:</p><p>Positive:</p><p><p>Subject + have/has + V3 + Object</p>I have wasted a lot of money in the last 2 years.<br>I have worked for this company for 20 years.<br>I have been to the USA.</p><br><p>Negative:</p><p><p>Subject + haven’t /hasn’t + V3 + Object</p>I haven’t seen her for 2 months.<br>She has never been to Paris.<br>They haven’t finished their project yet.</p><p>Question:</p><p><p>Have/has + Subject + V3 + Object</p>Haven’t you studied this course before?<br>Hasn’t she finished cooking yet?<br>Have you ever read a book?<br></p></p></p></div></div>")
    ...
    function draw_perfect_continuous_screen() {
        var elContainer_1 = $("body").empty();
        elContainer_1.append("<div class='container'><div id='back' class='btn btn-outline-light btn-lg btn-block mb-4 mt-4' style='border-radius: 2rem;'>Back</div></div>")
        elContainer_1.append("<div class='container'><div class='d-flex justify-content-center mt-3 mb-3'><div class='h5 text-white p-3 text-center' style='border-radius: 2rem; border: 1px solid white; width:'>Present Perfect Continuous Tense Definition</div></div><div class='pr-3 pl-3 text-white'><p><p>The Present Perfect Progressive (Continuous) shows duration of an activity that started in the past and continues in the present. Auxiliary verbs of Present Perfect Continuous are have/has. Note: I have, You have, They have, We have = I've, You've, They've, We've; She has, He has, It has = She's, He's, It's; but after these it is the necessity of the verb (been). These are time expressions: since, for, all morning/all day/all week.</p><p>NOTE: The Present Perfect Progressive (Continuous) isn't used with stative verbs. For that The Present Perfect is used. In some cases, there is no difference between Present Perfect and Present Perfect Progressive when the verb expresses the duration of present activity or something that happens regularly or usually. For example: live, work, study.</p><p>When there is no mention of time it means action is in progress recently.</p><p><p>Structure of Present Perfect Progressive</p><p>Positive:</p><p><p>Subject + have/has + been + V(ing) + Object</p>I've been learning for 5 years.<br>She's been doing her homework all day.<br>We've been playing football.</p><br><p>Negative:</p><p><p>Subject + haven't/hasn't + been + V(ing) + Object</p>He hasn't been learning Japanese for 10 years.<br>They haven't known each other for 3 years. NOTE: Know is STATIVE VERB that's why we use Present Perfect with it.<br>It's been raining all morning.</p><p>Question:</p><p><p>Have/Has + Subject + been + V(ing) + Object</p>Have you been doing housework for 3 hours?<br>How long has she been living in London? Also possible: How long has she lived in London?<br>What have you been doing for an hour?<br></p></p></p></div></div>")
...
function draw_future_screen() {
    ...
    function draw_simple_screen() {
        var elContainer_1 = $("body").empty();
        elContainer_1.append("<div class='container'><div id='back' class='btn btn-outline-light btn-lg btn-block mb-4 mt-4' style='border-radius: 2rem;'>Back</div></div>")
        elContainer_1.append("<div class='container'><div class='d-flex justify-content-center mt-3 mb-3'><div class='h5 text-white p-3 text-center' style='border-radius: 2rem; border: 1px solid white; width:'>Future Simple Tense Definition</div></div><div class='pr-3 pl-3 text-white'><p><p>Future Simple indicates the action in the near future. It means action will happen. These are rime expressions of the Future Time: next, tomorrow, soon, later. There 5 ways to indicate Future Time. They are Present Simple, Present Progressive (Continuous), Future Simple using the verb WILL and TO BE GOING TO, Modal Verbs: may, might. Present Simple expressing future is used in timetables or definite schedules. Present Progressive expressing future is used when the speaker has a planned event or definite intention. Future Simple using the verb WILL is used in predictions and spontaneous decisions. Future Simple using TO BE GOING TO is used in prior plans and predictions too. Modal Verbs: may, might is used when the speaker isn’t sure will the action happen.</p><p><p>Structure of Future Simple using <b>WILL</b></p><p>Positive:</p><p><p>Subject + will + V1 + Object</p>Somebody is calling.<br>I will pick up the phone.<br><br>We are run out of milk.<br>I will buy some later.</p><br><p>Negative:</p><p><p>Subject + will + not (won’t) + V1 + Object</p>Somebody is knocking the door. I’m afraid. I won’t open it.<br>I won’t go anywhere tomorrow.<br></p><p>Question:</p><p><p>Will + Subject + V1 + Object</p>I will have a party next Friday. Will you come?<br>Will you study Japanese next morning?<br></p><p>Structure of Future Simple using <b>TO BE GOING TO</b></p><p>Positive:</p><p><p>Subject + To be (am/is/are) going to + V1 + Object</p>I’m going to spend my vacation in Monaco. (It means I planned it before)<br>It is going to rain.</p><br><p>Negative:</p><p><p>Subject + To be (am/is/are) + not + going to + V1 + Object</p>There aren’t going to sleep.<br>She isn’t going to tell the truth.<br></p><p>Question:</p><p><p>To be (am/is/are) + Subject + going to + V1 + Object</p>Who are you going to be in the future?<br>What are you going to do in the holidays?<br></p></p><p><h5><b>Present Simple expressing Future Time</b></h5><p>The train leaves at 10 o’clock tomorrow.<br>Does museum open at 7 in the morning next Friday?<br>The plane doesn’t take off tomorrow night.</p></p><p><h5><b>Present Continuous expressing Future Time</b></h5><p>I’m having a meeting in five minutes.<br>He isn’t seeing a doctor tomorrow.<br>Are you meeting your friend next Monday?</p></p><p><h5><b>Modal Verbs: may, might</b></h5><p>He might pass this exam.<br>She might not take her phone to the party.<br>I may be coming to see you tomorrow.</p></p></p></div></div>")
    ...
    function draw_continuous_screen() {
        var elContainer_1 = $("body").empty();
        elContainer_1.append("<div class='container'><div id='back' class='btn btn-outline-light btn-lg btn-block mb-4 mt-4' style='border-radius: 2rem;'>Back</div></div>")
        elContainer_1.append("<div class='container'><div class='d-flex justify-content-center mt-3 mb-3'><div class='h5 text-white p-3 text-center' style='border-radius: 2rem; border: 1px solid white; width:'>Future Continuous Tense Definition</div></div><div class='pr-3 pl-3 text-white'><p><p>Future Progressive (Continuous) indicates an action that will be in progress in the future. It is similar to Present Continuous but in the future. These are time expressions of Future Continuous: while, when, whole, from… till, at … o’clock tomorrow, all day long. We’ll make it clear with examples.</p><p><p>Structure of Future Progressive:</p><p>Positive:</p><p><p>Subject + will + be + V(ing) + Object</p>I will be doing my homework tomorrow while my mom will be cooking a dinner.<br>He will be sleeping at 6 o’clock tomorrow evening.<br>She will be playing tennis when her father arrives.</p><br><p>Negative:</p><p><p>Subject + won’t + be + V(ing) + Object</p>It won’t be raining tomorrow morning.<br>He won’t be playing soccer at 8 o’clock tomorrow.<br>She won’t be cleaning the room at 2 o’clock tomorrow while her sister will be sleeping.</p><p>Question:</p><p><p>Will + Subject + be + V(ing) + Object</p>Will he be sleeping in the morning tomorrow?<br>Will it be snowing when the plane arrives?<br>Will she be having fun at the party tomorrow?<br></p></p></p></div></div>")
    ...
    function draw_perfect_screen() {
        var elContainer_1 = $("body").empty();
        elContainer_1.append("<div class='container'><div id='back' class='btn btn-outline-light btn-lg btn-block mb-4 mt-4' style='border-radius: 2rem;'>Back</div></div>")
        elContainer_1.append("<div class='container'><div class='d-flex justify-content-center mt-3 mb-3'><div class='h5 text-white p-3 text-center' style='border-radius: 2rem; border: 1px solid white; width:'>Future Perfect Tense Definition</div></div><div class='pr-3 pl-3 text-white'><p><p>Future Perfect is used to indicate an action that will be completed before another action in the future. It is like Past Perfect, but in future. If you understood Past Perfect, it will be much easier to understand this. These are time expressions of Future Perfect: by … tomorrow, before/after. Auxiliary verb of Future Perfect is (will have)</p><p><p>Structure of Future Perfect:</p><p>Positive:</p><p><p>Subject + will + have + V3 + Object</p>By the time I graduate the university, I will have spoken 4 languages.<br>Before Michele retires, he will have saved up one hundred thousand dollars.<br>By the time she returns next Thursday, her mom will have cooked the dinner.</p><br><p>Negative:</p><p><p>Subject + will + not (won’t) + have + V3 + Object</p>By the time I graduate the university, I won’t have spoken 4 languages.<br>Before Michele retires, he won’t have saved up one hundred thousand dollars.<br>By the time she returns next Thursday, her mom won’t have cooked the dinner.</p><p>Question:</p><p><p>Will + Subject + have + V3 + Object</p>Will you have spoken three languages, by the time you graduate the university?<br>Will he have saved up one hundred thousand dollars, before Michele retires?<br>Will her mom have cooked the dinner, by the time she returns next Thursday?<br></p></p></p></div></div>")
    ...
    function draw_perfect_continuous_screen() {
        var elContainer_1 = $("body").empty();
        elContainer_1.append("<div class='container'><div id='back' class='btn btn-outline-light btn-lg btn-block mb-4 mt-4' style='border-radius: 2rem;'>Back</div></div>")
        elContainer_1.append("<div class='container'><div class='d-flex justify-content-center mt-3 mb-3'><div class='h5 text-white p-3 text-center' style='border-radius: 2rem; border: 1px solid white; width:'>Future Perfect Continuous Tense Definition</div></div><div class='pr-3 pl-3 text-white'><p><p>Future Perfect Continuous tense describes actions that will be in progress when the other action happens in the future. Future Perfect and Future Perfect Progressive (Continuous) usually have the same meaning. Auxiliary verb is (will have been) Time expressions are: by, next, for, since.</p><p><p>Structure of Future Perfect Progressive (Continuous):</p><p>Positive:</p><p><p>Subject + will + have + been + V(ing)</p>I will have been waiting here for three hours by six o’clock tomorrow.<br>By 2002 I will have been living in Ashgabat for 18 years.<br>When I get home, my mother will have been making a cake for my birthday tomorrow.</p><br><p>Negative:</p><p><p>Subject + won’t + have + been + V(ing)</p>They won’t have been waiting her since 4 o’clock next Tuesday.<br>He won’t have been studying math course when he finishes university.<br>The building company won’t have been building the sport complex by 2025.</p><p>Question:</p><p><p>Will +Subject + have + been + V(ing)</p>Will he have been waiting her for three hours next time?<br>Will you have been playing football when your mother finishes the work?<br>Will they have been learning computer language by the end of this year?</p></p></p></div></div>")
        $("#back").click(function() {
            draw_future_screen()
        })
    }
